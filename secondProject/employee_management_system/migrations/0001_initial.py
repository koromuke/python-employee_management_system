# Generated by Django 2.1b1 on 2018-09-03 15:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='日付')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='employee_management_system.Department', verbose_name='部署')),
            ],
        ),
    ]
